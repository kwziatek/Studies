...
int main(int argc,char* args[])
{
    try {
        ...
        if(args[1][0]=='o'){
            ...
            double bok1 = stod(args[2]);
            double bok2 = stod(args[3]);
            double bok3 = stod(args[4]);
            double bok4 = stod(args[5]);
            double kat = stod(args[6]);
            if (stod(args[6]) == 90.0) {
                if (args[2] == args[3] && args[3] == args[4] && args[4] == args[5]) {
                    ...
                    if((bok1==bok3&&bok2==bok4) ||(bok1==bok2&&bok3==bok4) ||(bok1 == bok4 && bok2 == bok3)) {
                        figura *f = new prostokat(bok1, bok2, bok3, bok4, kat);
                        f->wypisz();
                    }
                    else throw new string("Nieprawidlowe boki prostokata");
                }
