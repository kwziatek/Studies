...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        /** Label containg current state of controlkey */
        final Label control= new Label("false");
        ...
        Scene scene = new Scene(borderPane, 1000, 500, Color.BLUE);
        ...
        /**
         * Event handler for controlkey being pressed
         */
        ...
        /**
         * Event handler for controlkey being released
         */
        ...
        sidebar.getChildren().addAll(circleBtn, triangleBtn, rectangleBtn,mousePos,mouseClicked,control,number);
